import { ADD_SERVICE, REMOVE_SERVICE, EDIT_SERVICE, CHANGE_SERVICE_FIELD, CHANGE_EDIT_FIELD, SET_EDIT_FORM, CHANGE_EDIT_MODE, SET_SERVICE_FORM } from './actionTypes';
